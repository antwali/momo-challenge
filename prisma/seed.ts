...
async function main() {
  await prisma.merchantCategory.upsert({
    ...
    create: { code: "GROCERIES", name: "Groceries", description: "Supermarkets, food" },
    update: {},
  });
  await prisma.merchantCategory.upsert({
    where: { code: "FUEL" },
  ...
  await prisma.merchantCategory.upsert({
    where: { code: "CLOTHES" },
    create: { code: "CLOTHES", name: "Clothes", description: "Boutiques, fashion" },
    update: {},
  });
  await prisma.merchantCategory.upsert({
    where: { code: "UTILITIES" },
    create: { code: "UTILITIES", name: "Utilities", description: "Bills, electricity" },
    update: {},
  });
